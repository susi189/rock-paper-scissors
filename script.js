...
function playRound(playerSelection, computerPlay){
    ...
    playerSelection === 'scissors' && computerPlay === 'rock'){
        computerScore ++;
        message.textContent = "Sorry, no luck this time! " + computerPlay[0].toUpperCase() + computerPlay.slice(1) + " beats " + playerSelection[0].toUpperCase() + playerSelection.slice(1) + ". Try again!"
        return message
    } else if (playerSelection === 'paper' && computerPlay === 'rock' ||
        playerSelection === 'scissors' && computerPlay === 'paper' ||
        playerSelection === 'rock' && computerPlay === 'scissors'){
            playerScore ++;
            message.textContent = "You win this round! " + playerSelection[0].toUpperCase() + playerSelection.slice(1) + " beats " + computerPlay[0].toUpperCase() + computerPlay.slice(1) + ". Next round!"
            return message
